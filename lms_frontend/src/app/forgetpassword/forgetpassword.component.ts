...
export class ForgetpasswordComponent implements OnInit {
  ...
  constructor(public sidenav: SidenavService,public forgetService:ForgetPasswordServicesService,public dialog:MatDialog){}
  ngOnInit(): void {
    this.sidenav.hide();
  }
  onSubmit(){
    if(this.emails.email!=='' && this.emails.email!==null){
      this.forgetService.generateRandomToken(this.emails).subscribe((res:any)=>{
        console.log(res);
